...
creditCards = within(creditCards, BAMT4 <- (BILL_AMT4 - BILL_AMT4 %% 100) / 10000)
creditCards = within(creditCards, BAMT5 <- (BILL_AMT5 - BILL_AMT5 %% 100) / 10000)
creditCards = within(creditCards, BAMT6 <- (BILL_AMT6 - BILL_AMT6 %% 100) / 10000)
creditCards = within(creditCards, PAMT1 <- (PAY_AMT1 - PAY_AMT1 %% 100) / 10000)
creditCards = within(creditCards, PAMT2 <- (PAY_AMT2 - PAY_AMT2 %% 100) / 10000)
creditCards = within(creditCards, PAMT3 <- (PAY_AMT3 - PAY_AMT3 %% 100) / 10000)
creditCards = within(creditCards, PAMT4 <- (PAY_AMT4 - PAY_AMT4 %% 100) / 10000)
creditCards = within(creditCards, PAMT5 <- (PAY_AMT5 - PAY_AMT5 %% 100) / 10000)
creditCards = within(creditCards, PAMT6 <- (PAY_AMT6 - PAY_AMT6 %% 100) / 10000)
